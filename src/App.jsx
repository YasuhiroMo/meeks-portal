...
const MANUALS = [
  {
    ...
    sections: [
      ...
      { title: "退出前5点確認", content: "①ブーム格納 — 縮小・旋回・定位置に格納済み\n②アウトリガー格納 — 左右格納・敷板回収・ロック確認\n③ワイヤー乱巻なし — 確認済み\n④フック格納 — 格納位置に固定済み\n⑤PTO解除 — 解除済みであることを確認\n\n呼称：「ブーム格納よし！アウトリガー格納よし！ワイヤー乱巻なしよし！フック格納よし！PTO解除よし！」" },
    ],
  },
  {
    id: "accident", title: "事故対応手順書", icon: "🚨",
    tag: "2025年度版 修正版", color: "#C0392B",
    sections: [
  ...
  {
    id: "checklist", title: "ミス防止チェックリスト集", icon: "✅",
    tag: "2025年度版 修正版", color: "#1E8449",
    sections: [
  ...
  {
    id: "health", title: "健康管理・季節別対策", icon: "💪",
    tag: "安全教育資料", color: "#2E86C1",
    sections: [
  ...
  {
    id: "driving", title: "走行中の安全", icon: "🚛",
    tag: "安全教育資料", color: "#6C3483",
    sections: [
  ...
  {
    id: "kyt", title: "危険予知トレーニング（KYT）", icon: "⚠️",
    tag: "安全教育資料", color: "#D4AC0D",
    sections: [
  ...
  {
    id: "crane", title: "クレーン操作安全手順", icon: "🏗️",
    tag: "安全教育資料", color: "#A04000",
    sections: [
  ...
  {
    id: "loading", title: "積込・養生手順", icon: "📦",
    tag: "安全教育資料", color: "#1A5276",
    sections: [
      { title: "積込の基本", content: "・配送順番を考慮した積込（先に降ろすものを外側に）\n・重心を低く、偏りのないように積載\n・荷締めはラッシングベルト最低2本以上\n・製品間に当て物（角当て）を入れる\n・メーカー毎の養生シート準備\n・後部はみ出し部に赤い布を取り付け" },
    ],
  },
  {
    id: "site_manner", title: "現場マナー", icon: "🏠",
    tag: "安全教育資料", color: "#117A65",
    sections: [
      { title: "現場でのルール", content: "・遣り方（やりかた）・水糸・饅頭を絶対に破損しない\n・地縄の内側に製品を置かない\n・防湿シートを汚さない・破損しない\n・近隣住宅の塀・車両・植栽に注意\n・現場を汚した場合は必ず清掃\n・ゴミのポイ捨て厳禁" },
    ],
  },
  {
    id: "law12", title: "法定12項目ドライバー教育資料", icon: "📚",
    tag: "国土交通省告示準拠", color: "#34495E",
    sections: [
  ...
  {
    id: "driver_edu", title: "ドライバー教育チェック表", icon: "📝",
    tag: "2025年度版", color: "#6C3483",
    sections: [
  ...
  {
    id: "customer", title: "顧客満足・マナー", icon: "🤝",
    tag: "安全教育資料", color: "#B7950B",
    sections: [
      { title: "マナーの基本", content: "・作業服は清潔なものを着用\n・ヘルメット・安全靴・保護手袋を着用\n・お客様・近隣住民へ積極的に挨拶\n・丁寧な言葉遣い\n・時間指定厳守（早すぎてもNG）\n・遅れる場合は事務所へ早めに報告\n・現場・現場付近は禁煙\n・ゴミのポイ捨て厳禁\n・車両の移動を要求されたら速やかに対応" },
    ],
  },
  {
    id: "mistakes", title: "よくあるミスと防止策", icon: "🔍",
    tag: "安全教育資料", color: "#7D3C98",
    sections: [
...
/* ===== チャットボット知識ベース ===== */
const KB = `あなたはメークス株式会社 物流事業部の安全教育AIアシスタントです。
ドライバーや従業員からのあらゆる質問に、親切・丁寧・正確に回答してください。
業務に直接関係ない質問でも、ドライバーの安全や健康に関わる範囲で柔軟に対応してください。
回答は日本語で、わかりやすく具体的に。必要に応じて箇条書きを使ってください。

■回答のルール
・手順書や教育資料に記載がある内容は正確に回答する
・記載がない内容でも、ドライバーの安全・健康・業務改善に役立つ一般的なアドバイスは積極的に行う
・わからない場合は「管理者にご確認ください（090-1213-9803）」と案内する
・雑談や励ましにも温かく対応する。ドライバーの味方であることを忘れない
...
■出発前5点確認（会社出発前に実施）
①アウトリガー格納確認（敷板回収・ロック確認）
②ブーム格納確認（ワイヤー乱巻なし・正しく格納）
③製品荷締め確認（落下・荷崩れの可能性なし）
④部材荷締め確認（走行中に飛ばされる可能性なし）
⑤不具合箇所の修正（不具合を認識したまま出発禁止）
...
■納入作業手順（No.1〜12）
No.1 出発前点検：5点確認実施。不具合ある状態で出発しない。
No.2 現場到着：現場前に停車。監督・業者に電話連絡。8:00指定は30分以上前の進入禁止。
No.3 荷降ろし位置確認：指示内容と乖離ないか確認。危険時は監督に相談。
No.4 車両停車位置に移動：桝・水道・障害物把握。スタック可能性あれば受注課に連絡。
No.5 アウトリガー設置：地盤確認・敷板設置・最大位置まで張出し。U字溝蓋上禁止。
No.6 荷解き：荷崩れ確認後、足元の安全確保。
No.7 荷降ろし開始：頭上確認（電線・電話線）必須。斜め吊り禁止。風速10m/s以上は作業中止。
No.8 荷降ろし終了：製品養生・納品写真撮影・明細書にサイン受領。
No.9 ジブ・ブーム格納：頭上確認しながら格納。急旋回禁止。
No.10 アウトリガー格納：左右格納・敷板格納・PTO解除。退出前5点確認。
No.11 荷締め・出発準備：荷台荷締め・出発前写真撮影。
No.12 帰庫：荷台確認・整理・盗難防止装置作動・ハンドルロック。
...
②救護・通報（119番・110番）
③会社連絡（配車担当：090-1213-9803）
【絶対禁止】現場離脱・事故報告の隠蔽・示談交渉・「私が悪い」等の責任を認める発言・SNS投稿
...
■クレーン操作
・小型移動式クレーン運転技能講習修了証を常時携帯
・アウトリガー：最大位置まで張り出し必須。片側のみ禁止。U字溝蓋上禁止。敷板必須。
・定格荷重を超える荷物は吊り上げない
・吊り荷の下に人を立ち入らせない
・急激な操作禁止。移動しながらの操作禁止。複数レバーの同時操作禁止。
・旋回時は頭上確認（電線・電話線）
・風速10m/s以上は作業中止

■健康管理
・睡眠：1日7時間以上。SAS（睡眠時無呼吸症候群）の自覚があれば医師に相談。
・飲酒：ビール中瓶1本＝分解に約3〜4時間。3本＝約9〜12時間。アルコールチェック基準は0.00mg/L。
・食事：朝食必須（血糖値低下防止）。昼食は腹八分目（満腹は眠気誘発）。こまめな水分補給。
・持病・服薬：眠気の副作用がある薬は会社に申告。自己判断の服薬中止は禁止。

■季節別対策
・熱中症予防：WBGT31以上は原則外作業中止。1時間にコップ2〜3杯の水分補給。軽度（めまい）→涼しい場所で水分補給。重度（意識障害）→119番。
・冬季：スタッドレスタイヤ12月〜3月必須。凍結注意：橋の上・トンネル出入口・日陰。
・台風：暴風域予想→運行中止。風速15m/s以上→走行危険。冠水道路進入禁止。
・花粉症：主治医に「運転業務」を伝え眠気の少ない薬を処方。市販薬の自己判断は危険。
...
■走行安全
・住宅街20km/h以下。一般道は法定速度厳守。
・ながら運転厳禁。スマホは安全な場所に停車してから。
・あおり運転：挑発に乗らず安全な場所に移動→110番。
・高速道路故障時：ハザード→路肩停車→三角表示板→車外避難（ガードレール外へ）。

■KYT（危険予知トレーニング）4ラウンド法
第1R：危険の洗い出し（どんな危険があるか）
第2R：危険の絞り込み（最も重要な危険は）
第3R：対策の立案（あなたならどうする）
第4R：行動目標の設定（指差し呼称項目を決定）
代表シナリオ：住宅街バック走行→降車確認、雨天荷降ろし→敷板多め、電線下クレーン→安全距離確保

■積込・養生
・配送順番を考慮した積込（先に降ろすものを外側に）
・重心を低く偏りなく積載
・ラッシングベルト最低2本以上
・製品間に角当て。はみ出し部に赤い布。
...
・地縄の内側に製品を置かない
・防湿シートを汚さない・破損しない
・現場を汚した場合は必ず清掃。現場・現場付近は禁煙。

■法定12項目（要点）
第1項：安全最優先の心構え
第2項：日常点検・アルコールチェック（0.00mg/L）・運転日報提出
第3項：内輪差・オーバーハング・死角に注意
第4項：重心低く・ラッシング2本以上・赤い布
第5項：過積載→制動距離増大・横転リスク・行政処分
第10項：「だろう」→「かもしれない」運転
第12項：バックカメラ等は補助。目視確認必須。

■顧客満足
・時間指定厳守（早すぎてもNG）。遅れる場合は事務所へ早めに報告。
・清潔な作業服・ヘルメット・安全靴・保護手袋
・お客様・近隣住民へ積極的に挨拶。丁寧な言葉遣い。

■よくあるミスと防止策
・誤配送→到着時に住所・物件名を配車表と照合
・数量ミス→声に出して1つずつ数える
・明細書置き忘れ→退出前に書類の仕分け確認
・ブーム格納忘れ→出発前5点確認を毎回実施
・敷板回収忘れ→退出前チェックリストに含める`;
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#0d1b2a,#1b2d4a,#0d1b2a)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20, fontFamily: "'Helvetica Neue',Arial,'Hiragino Sans',sans-serif" }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: "40px 28px", width: "100%", maxWidth: 420, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 700, color: "#1a2d4a", marginBottom: 6 }}>メークス物流事業部</h1>
          <p style={{ fontSize: 15, color: "#888" }}>統合ポータルシステム</p>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div>
            <label style={{ fontSize: 14, fontWeight: 600, color: "#555", display: "block", marginBottom: 6 }}>社員番号</label>
            <input value={empId} onChange={(e) => { setEmpId(e.target.value); setErr(""); }} placeholder="例: D001" style={S.input} />
          </div>
          <div>
            <label style={{ fontSize: 14, fontWeight: 600, color: "#555", display: "block", marginBottom: 6 }}>氏名</label>
            <input value={name} onChange={(e) => { setName(e.target.value); setErr(""); }} placeholder="例: 山田太郎" style={S.input} />
          </div>
          <div>
            <label style={{ fontSize: 14, fontWeight: 600, color: "#555", display: "block", marginBottom: 6 }}>パスワード</label>
            <input type="password" value={pw} onChange={(e) => { setPw(e.target.value); setErr(""); }} onKeyDown={(e) => e.key === "Enter" && login()} placeholder="社内共通パスワード" style={S.input} />
          </div>
          {err && <div style={{ background: "#ffeaea", color: "#c0392b", padding: "12px 16px", borderRadius: 10, fontSize: 15, textAlign: "center" }}>{err}</div>}
          <button onClick={login} style={{ ...S.btn("#1B4F72"), width: "100%", padding: "16px", fontSize: 17, marginTop: 4 }}>ログイン</button>
        </div>
        <p style={{ textAlign: "center", fontSize: 13, color: "#bbb", marginTop: 24 }}>※ 社内関係者のみアクセス可能です</p>
      </div>
    </div>
  );
}
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "10px 12px 0" : "14px 16px 0" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <div style={{ color: "#fff", fontSize: isMobile ? 14 : 16, fontWeight: 700 }}>メークス物流事業部</div>
              {!isMobile && <div style={{ color: "#3498DB", fontSize: 11 }}>統合ポータル</div>}
            </div>
          </div>
...
function Home({ setTab, user }) {
  const isMobile = useIsMobile();
  const cards = [
    { icon: "📄", title: "手順書を確認する", desc: "納入手順・事故対応・チェックリスト等", tab: "manual", color: "#1B4F72" },
    { icon: "🎓", title: "Eラーニングを受講", desc: `全${COURSES.length}コース学習・ランダム30問テスト`, tab: "elearning", color: "#1E8449" },
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: isMobile ? "20px 12px" : "32px 16px" }}>
      <div style={{ textAlign: "center", marginBottom: isMobile ? 20 : 32 }}>
        <div style={{ fontSize: isMobile ? 42 : 52, marginBottom: 10 }}>🚚</div>
        <h1 style={{ fontSize: isMobile ? 20 : 26, fontWeight: 700, color: "#1a2d4a", marginBottom: 8 }}>物流事業部 統合ポータル</h1>
        <p style={{ color: "#888", fontSize: isMobile ? 14 : 16 }}>ようこそ、{user?.name}さん</p>
      </div>
      ...
      <div style={{ ...S.card, marginTop: 24, padding: "20px 24px" }}>
        <h3 style={{ fontSize: 16, fontWeight: 700, color: "#C0392B", marginBottom: 12 }}>🚨 緊急連絡先</h3>
        <div style={{ fontSize: 15, color: "#333", lineHeight: 2.4 }}>
          配車担当：<a href="tel:09012139803" style={{ color: "#1B4F72", fontWeight: 600, textDecoration: "none" }}>090-1213-9803</a><br />
          受注課：<a href="tel:09063018209" style={{ color: "#1B4F72", fontWeight: 600, textDecoration: "none" }}>090-6301-8209</a><br />
          本社 / 時間外：<a href="tel:0297551380" style={{ color: "#1B4F72", fontWeight: 600, textDecoration: "none" }}>0297-55-1380</a>
        </div>
      </div>
    </div>
  );
  ...
  if (!sel)
    return (
      <div style={{ maxWidth: 1000, margin: "0 auto", padding: isMobile ? "20px 12px" : "24px 16px" }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1a2d4a", marginBottom: 16 }}>📄 手順書一覧</h2>
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fill,minmax(280px,1fr))", gap: 14 }}>
          {MANUALS.map((m) => (
            <div key={m.id} onClick={() => { setSel(m); setSec(0); }} style={{ ...S.card, padding: "20px", cursor: "pointer", borderLeft: `5px solid ${m.color}` }}>
              ...
              <div style={{ fontSize: 13, color: "#aaa", marginTop: 4 }}>{m.sections.length}セクション</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: isMobile ? "16px 10px" : "24px 16px" }}>
      ...
      <div style={S.card}>
        <div style={{ background: `linear-gradient(135deg,${c.color},${c.color}cc)`, color: "#fff", padding: isMobile ? "18px" : "24px" }}>
          ...
          <div style={{ fontSize: 14, opacity: 0.8, marginTop: 4 }}>{c.cat} • 全{c.secs.length}セクション</div>
        </div>
        <div style={{ padding: isMobile ? "18px" : "24px" }}>
          ...
          <div style={{ fontSize: 13, color: c.color, fontWeight: 700, marginBottom: 6 }}>セクション {sec + 1}/{c.secs.length}</div>
...
function RandomTest({ user, onBack, onDone }) {
  ...
  if (questions.length === 0) return <div style={{ textAlign: "center", padding: 60, color: "#666", fontSize: 16 }}>問題を準備中...</div>;
      ...
      <div style={S.card}>
        <div style={{ background: "linear-gradient(135deg,#1B4F72,#2E86C1)", color: "#fff", padding: isMobile ? "18px" : "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <h2 style={{ fontSize: isMobile ? 18 : 20, fontWeight: 700, margin: 0 }}>総合確認テスト</h2>
              <div style={{ fontSize: isMobile ? 12 : 14, opacity: 0.8, marginTop: 4 }}>
                ランダム{TEST_Q_COUNT}問 • 合格: {TEST_PASS_LINE}問以上（{PASS_RATE}%）
              </div>
            </div>
          </div>
          <div style={{ fontSize: 14, marginTop: 10, opacity: 0.7 }}>受験者: {user.empId} {user.name}</div>
        </div>
        ...
        <div style={{ padding: isMobile ? "16px" : "24px" }}>
          {sub && (
            <div style={{ background: sub.pa ? "#d4edda" : "#f8d7da", borderRadius: 14, padding: isMobile ? "18px" : "24px", marginBottom: 24, border: "2px solid " + (sub.pa ? "#28a745" : "#dc3545"), textAlign: "center" }}>
              <div style={{ fontSize: 44, marginBottom: 8 }}>{sub.pa ? "🎉" : "📚"}</div>
              <div style={{ fontSize: isMobile ? 18 : 22, fontWeight: 700, color: sub.pa ? "#155724" : "#721c24" }}>
                {sub.pa ? "合格！おめでとうございます！" : "不合格 — 再学習してください"}
              </div>
              <div style={{ fontSize: 18, marginTop: 8, color: "#555" }}>
                {sub.sc}/{TEST_Q_COUNT}問正解（{Math.round((sub.sc / TEST_Q_COUNT) * 100)}%）
              </div>
          ...
          {!sub && (
            <div style={{ background: "#f0f2f5", borderRadius: 10, padding: "12px 16px", marginBottom: 20, display: "flex", alignItems: "center", gap: 12, position: "sticky", top: isMobile ? 85 : 95, zIndex: 10 }}>
              <div style={{ fontSize: 14, color: "#666", whiteSpace: "nowrap" }}>回答</div>
...
function ELearning({ user }) {
  ...
  if (!loaded) return <div style={{ textAlign: "center", padding: 60, color: "#666", fontSize: 16 }}>読み込み中...</div>;
    ...
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "16px 10px" : "24px 16px" }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#1a2d4a,#2E86C1)", borderRadius: 16, padding: isMobile ? "18px" : "24px", color: "#fff", marginBottom: 24 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <div>
            <div style={{ fontSize: 13, opacity: 0.7 }}>受講者</div>
          ...
          <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: 12, opacity: 0.7 }}>学習済み</div>
            </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
              ...
              <h3 style={{ fontSize: isMobile ? 16 : 18, fontWeight: 700, color: "#1a2d4a", margin: 0 }}>総合確認テスト</h3>
            </div>
            <div style={{ fontSize: 14, color: "#666", lineHeight: 1.8 }}>
              全{COURSES.length}コースからランダム{TEST_Q_COUNT}問<br />
              毎回出題が変わります • 合格{PASS_RATE}%
            </div>
            {lastTest && (
              <div style={{ fontSize: 13, color: "#888", marginTop: 8 }}>
                前回: {new Date(lastTest.date).toLocaleDateString("ja-JP")} —
                <span style={{ color: lastTest.passed ? "#27AE60" : "#E74C3C", fontWeight: 700 }}>
                  {" "}{lastTest.score}/{TEST_Q_COUNT}（{lastTest.pct}%）{lastTest.passed ? " 合格" : " 不合格"}
                </span>
                {bestTest && bestTest.score !== lastTest.score && (
                  <span style={{ marginLeft: 8, color: "#2E86C1" }}>最高: {bestTest.score}/{TEST_Q_COUNT}</span>
                )}
              </div>
            )}
          </div>
      ...
      {testHist.length > 0 && (
        <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #e0e0e0", padding: isMobile ? "14px" : "20px", marginBottom: 24 }}>
          <div style={{ fontSize: 15, fontWeight: 700, color: "#1a2d4a", marginBottom: 12 }}>
            📊 テスト履歴（直近{Math.min(testHist.length, 5)}回）
          </div>
      ...
      {/* コース学習一覧 */}
      <div style={{ fontSize: 18, fontWeight: 700, color: "#1a2d4a", marginBottom: 8 }}>📖 学習教材</div>
      <div style={{ fontSize: 14, color: "#888", marginBottom: 20 }}>テスト前に各コースの教材を読んで学習してください。</div>
      {cats.map((cat) => (
                ...
                <div key={c.id} onClick={() => setSelC(c.id)} style={{ background: "#fff", borderRadius: 14, padding: "20px", cursor: "pointer", border: "1px solid #e0e0e0", position: "relative", overflow: "hidden", WebkitTapHighlightColor: "transparent" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ fontSize: 13, color: "#888", marginTop: 2 }}>{c.secs.length}セクション • {c.quiz.length}問</div>
                    </div>
                    {learned && <div style={{ background: "#d4edda", color: "#155724", fontSize: 12, fontWeight: 700, padding: "4px 10px", borderRadius: 8, whiteSpace: "nowrap" }}>学習済</div>}
                  </div>
                </div>
              );
            })}
...
/* ===== Chatbot（ローカルKB応答 + API対応） ===== */
function Chatbot() {
  const [msgs, setMsgs] = useState([
    { role: "assistant", content: "こんにちは！物流部AIアシスタントです。\n手順書・緊急連絡先・KYT・法令など何でも聞いてください。" },
  ]);
  ...
  /* ローカルKBマッチング（API不要のフォールバック） */
  const localAnswer = (q) => {
    const kw = [
      { keys: ["出発前", "5点", "五点", "出発"], ans: "【出発前5点確認】\n①アウトリガー格納確認\n②ブーム格納確認\n③製品荷締め確認\n④部材荷締め確認\n⑤不具合箇所の修正\n\n不具合を認識したままの出発は禁止です。指差し呼称で確認してください。" },
      { keys: ["退出前", "退出"], ans: "【退出前5点確認】\n①ブーム格納\n②アウトリガー格納\n③ワイヤー乱巻なし\n④フック格納\n⑤PTO解除\n\n呼称：「ブーム格納よし！アウトリガー格納よし！ワイヤー乱巻なしよし！フック格納よし！PTO解除よし！」" },
      { keys: ["事故", "起き", "発生"], ans: "【事故発生時の3原則】\n①安全確保（二次災害の防止）\n②救護・通報（119番・110番）\n③会社連絡（配車担当：090-1213-9803）\n\n【絶対禁止】現場離脱・報告隠蔽・示談交渉・責任を認める発言・SNS投稿" },
      { keys: ["電線", "感電", "切断"], ans: "【電線切断時の対応】\n①絶対に車両から降りない（感電の危険）\n②110番に連絡\n③配車担当に連絡（090-1213-9803）\n④東京電力に連絡（0120-995-007）\n⑤車内で待機" },
      { keys: ["連絡先", "電話", "番号"], ans: "【緊急連絡先】\n配車担当者：090-1213-9803\n茨城工場受注課：090-6301-8209（8:00〜17:00）\nメークス本社：0297-55-1380\n時間外：0297-55-1380\n東京電力：0120-995-007\nNTT：0120-444-113" },
      { keys: ["時間外", "夜間", "休日"], ans: "【時間外連絡先】\n0297-55-1380（17:00〜翌8:00・土日祝）\n本社と同じ番号で自動転送されます。" },
      { keys: ["改善基準", "拘束", "運転時間"], ans: "【改善基準告示】\n・1日の拘束時間：原則13時間以内（上限16時間）\n・1か月：原則284時間\n・連続運転：4時間以内に30分以上休憩\n・勤務間休息：継続11時間以上が基本" },
      { keys: ["熱中症", "暑さ", "WBGT"], ans: "【熱中症予防】\n・WBGT31以上は原則外作業中止\n・1時間にコップ2〜3杯の水分補給\n・軽度（めまい）→涼しい場所で水分補給\n・重度（意識障害）→すぐに119番通報" },
      { keys: ["クレーン", "風速", "作業中止"], ans: "【クレーン作業】\n・風速10m/s以上は作業中止\n・アウトリガー最大張り出し必須（片側禁止）\n・敷板必ず設置\n・U字溝蓋上への設置禁止\n・吊り荷の下に立入禁止" },
      { keys: ["アウトリガー"], ans: "【アウトリガー】\n・最大位置まで張り出し必須\n・片側のみの使用は禁止\n・U字溝蓋の上への設置禁止\n・必ず敷板を設置\n・地盤を確認してから設置" },
      { keys: ["KYT", "危険予知"], ans: "【KYT 4ラウンド法】\n第1R：危険の洗い出し（どんな危険があるか）\n第2R：危険の絞り込み（最も重要な危険は）\n第3R：対策の立案（あなたならどうする）\n第4R：行動目標の設定（指差し呼称項目を決定）" },
      { keys: ["飲酒", "アルコール", "ビール"], ans: "【飲酒と運転】\n・ビール中瓶1本＝分解に約3〜4時間\n・3本＝約9〜12時間かかります\n・アルコールチェックは0.00mg/Lが基準\n・少量でも翌朝に残る可能性があります" },
      { keys: ["あおり", "煽り"], ans: "【あおり運転を受けた場合】\n挑発に乗らず安全な場所に移動し、110番通報してください。" },
      { keys: ["積込", "荷締め", "ラッシング"], ans: "【積込・荷締め】\n・配送順番を考慮して積込\n・重心を低く偏りなく\n・ラッシングベルト最低2本以上\n・製品間に角当てを入れる\n・はみ出し部に赤い布" },
      { keys: ["スタッドレス", "冬", "凍結"], ans: "【冬季対策】\n・スタッドレスタイヤは12月〜3月必須\n・凍結注意箇所：橋の上・トンネル出入口・日陰\n・急ブレーキ・急ハンドル禁止" },
    ];
    ...
    <div style={{ maxWidth: 800, margin: "0 auto", padding: isMobile ? "8px" : "16px", height: "calc(100vh - 130px)", display: "flex", flexDirection: "column" }}>
      <div style={{ ...S.card, flex: 1, display: "flex", flexDirection: "column" }}>
        <div style={{ padding: "16px 20px", borderBottom: "1px solid #e0e0e0", display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ fontSize: 28 }}>🤖</span>
          <div>
            <div style={{ fontSize: 16, fontWeight: 700, color: "#1a2d4a" }}>物流部 AIアシスタント</div>
            <div style={{ fontSize: 12, color: "#27AE60" }}>● 手順書・KYT・法令を学習済み</div>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 420, margin: "60px auto", padding: 20 }}>
        <div style={{ ...S.card, padding: "36px 28px" }}>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1a2d4a", marginTop: 10 }}>管理者ログイン</h2>
          </div>
          ...
          <button onClick={login} style={{ ...S.btn("#C0392B"), width: "100%", padding: "16px", fontSize: 17 }}>ログイン</button>
        </div>
      </div>
    );
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "16px 10px" : "24px 16px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 10 }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: "#1a2d4a" }}>🔐 管理者ダッシュボード</h2>
        <button onClick={loadResults} style={{ ...S.btn("#2471A3"), padding: "10px 18px", fontSize: 14 }}>🔄 更新</button>
      </div>
      ...
      {view === "dashboard" && (
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : "repeat(auto-fit,minmax(160px,1fr))", gap: 14, marginBottom: 20 }}>
          {[
            ["📊", "総受験回数", results.length],
            ["👤", "受験者数", uniq.length + "名"],
            ["✅", "合格数", passC],
            ["📈", "合格率", results.length ? Math.round((passC / results.length) * 100) + "%" : "-%"],
          ].map(([ic, l, v]) => (
      ...
      {view === "results" && (
        <div style={S.card}>
          <div style={{ padding: "16px 20px", borderBottom: "1px solid #e0e0e0", fontSize: 16, fontWeight: 700, color: "#1a2d4a" }}>全受験履歴</div>
          {results.length === 0 ? (
            <div style={{ padding: 30, textAlign: "center", color: "#aaa", fontSize: 15 }}>まだ受験データがありません</div>
          ) : (
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: isMobile ? 13 : 14, minWidth: 600 }}>
                <thead>
                  <tr style={{ background: "#f8f9fa" }}>
                    {["日時", "社員番号", "氏名", "コース", "スコア", "結果"].map((h) => (
                ...
                <tbody>
                  {results.map((r, i) => (
                    <tr key={i} style={{ borderBottom: "1px solid #f0f0f0" }}>
                      ...
                      <td style={{ padding: "12px 14px" }}>{r.score}/{r.totalQ}（{r.pct}%）</td>
      ...
      {view === "answers" && (
        <div style={S.card}>
          <div style={{ padding: "16px 20px", borderBottom: "1px solid #e0e0e0", fontSize: 16, fontWeight: 700, color: "#1a2d4a" }}>📝 回答集【管理者用】</div>
          <div style={{ background: "#fff3cd", padding: "12px 20px", fontSize: 14, color: "#856404", borderBottom: "1px solid #ffc107" }}>
            ⚠ 本資料は管理者・教育担当者用です。ドライバーには配布しないでください。
          </div>
      ...
      {view === "guide" && (
        <div style={S.card}>
          <div style={{ padding: "16px 20px", borderBottom: "1px solid #e0e0e0", fontSize: 16, fontWeight: 700, color: "#1a2d4a" }}>📝 コンテンツ変更ガイド</div>
          <div style={{ padding: "24px", fontSize: 16, lineHeight: 2.2, color: "#333" }}>
            <p style={{ fontWeight: 700, color: "#C0392B", marginBottom: 14 }}>手順書・Eラーニングの内容変更が必要な場合：</p>
            <p>Claudeに指示することで変更できます。</p>
            <div style={{ background: "#f8f9fa", borderRadius: 10, padding: "18px 20px", marginTop: 14, lineHeight: 2 }}>
              変更依頼の例：<br />
              • 「納入手順書の○○を追加して」<br />
              • 「テスト問題を△△に変更して」<br />
              • 「AIチャットの知識ベースに□□を追加」<br />
              • 「法令改正に伴い数値を更新」
            </div>
          </div>
        </div>
